  ...
  return (
    <Link to={`/video/${video?.videoId}`}>
      <div className="flex mb-3">
        <div className="relative h-24 lg:h-20 xl:h-24 w-40 min-w-[168px] lg:w-32 lg:min-w-[120px] xl:w-40 xl:min-w-[160px] rounded-xl bg-slate-800 overflow-hidden">
          <img src={video?.thumbnails[0]?.url} className="h-full w-full object-cover" alt="Image" />
          {video.lengthSeconds && (
